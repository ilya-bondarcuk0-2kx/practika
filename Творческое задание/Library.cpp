...
void Library::showBook(std::string name)
{
	...
	std::cout << "Ќе найдено ни одной книги с таким именем!" << std::endl;
	return;
}
...
void Library::showEmployee(std::string surname)
{
	...
	std::cout << "Ќе найдено ни одного работника с такой фамилией!" << std::endl;
	return;
}
...
void Library::showClient(std::string surname)
{
	...
	std::cout << "Ќе найдено ни одного клиента с такой фамилией!" << std::endl;
	return;
}
...
//		}
//	}
//	std::cout << "“акой книги нет в библиотеке!" << std::endl;
//}
//
...
//	if (!isPrefered)
//	{
//		std::cout << "Ќе найдено ни одной книги" << std::endl;
//	}
//}
//
