...
Encyclopedia* Application::enciclop = new Encyclopedia("Любовь Орлова", "Медицинская энциклопедия", "Энциклопедия", "Хирургическая операция - это механическое воздейсвтие...", 896, 9.8, "Медицина");
Journal* Application::journal = new Journal("Лев", "Тошка и компания", "Журнал о животных", "ПАНДА ИЛИ ЕНОТ?!" , 70, 10, "Лев");
Bookshelf* Application::bookShelf = new Bookshelf();
Book* Application::book1 = new Book("Агата Кристи", "Kill", "Детектив", "Невозможное случиться не может, поэтому оно должно стать возможным, несмотря ни на что.", 288, 8.8);
Book* Application::book2 = new Book("Артур Конан-Дойл", "Записики о Шерлоке Холмсе", "Детектив", "Ах, сколько зла на свете, и хуже всего, когда злые дела совершает умный человек!", 384, 7.9);
