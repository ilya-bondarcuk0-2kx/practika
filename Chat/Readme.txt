...
Перед описанием! В проекте уже есть один пользователь. Его информацию можно найти в папке users. Она идет поледовательно -> Логин, пароль, имя, id. 
Данный пользователь создан для тестов! Так что Enjoy! 
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	2. Перегруженные операторы ввода-вывода, которые будут нужны для взаимодействия с потоками (записи пользователя в файл и выгрузка).
